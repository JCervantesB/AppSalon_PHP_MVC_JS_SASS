...
function seleccionarHora() {
    ...
    // Deshabilitar horas pasadas o no válidas
    opcionesHora.forEach(function (opcion) {
        const horaOpcion = opcion.value.split(":")[0];
        if (horaOpcion < new Date().getHours() || horaOpcion < 10 || horaOpcion > 18) {
